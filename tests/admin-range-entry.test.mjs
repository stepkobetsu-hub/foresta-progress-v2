...
assert.match(app, /章・UNITごとの一括操作/);
assert.match(app, /selectChapterGroup/);
assert.match(app, /clearChapterGroup/);

console.log("admin range entry tests: 11 assertions passed");
